...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const colorGeneratorBtnMobile = document.getElementById(
    "color-generator-btn-mobile",
  );
  const colorGeneratorOverlay = document.getElementById(
  ...
  async function analyzeColor(hexColor) {
    ...
    try {
      ...
      // themes variables
      state.monochromeColors = await fetchColorPalette(
        hexInput,
        "monochrome",
        5,
      );
