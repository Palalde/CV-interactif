...
(function () {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const overlaySearchSlot = overlay.querySelector(
    ...
    const headerSearchInput = headerSearchForm
      ? headerSearchForm.querySelector(".search-input")
      : null;
    const headerSearchBtn = headerSearchForm
      ? headerSearchForm.querySelector(".search-btn")
      : null;
    ...
    function showInitialHistory() {
      ...
      import("../search/search-history.js")
        .then((module) => {
    ...
    function openOverlay(trigger) {
      ...
      if (headerSearchInput) {
        ...
        headerSearchInput.setAttribute(
          "placeholder",
          "Recherchez dans toutes les compétences, projets, langues…",
        );
      }
    ...
    if (headerSearchInput) {
      ...
      headerSearchInput.addEventListener("input", () => {
        if (
          ...
          const historyBlock = resultsContainer?.querySelector(
