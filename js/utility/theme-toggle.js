function updateNavIcons(isLight) {
  ...
  // Ping
  document
    .querySelectorAll('.contact-icon[alt="Localisation"]')
    .forEach((img) => {
      img.src = isLight
  ...
  // Mail
  document
    .querySelectorAll('.contact-icon.social-icon[alt="Email"]')
    .forEach((img) => {
      img.src = isLight
        ? "/img/nav-icon/lightmode/contact-noir.png"
        : "/img/nav-icon/darkmode/contact-blanc.png";
  ...
  // LinkedIn
  document
    .querySelectorAll('.contact-icon.social-icon[alt="LinkedIn"]')
    .forEach((img) => {
      img.src = isLight
  ...
  // GitHub
  document
    .querySelectorAll('.contact-icon.social-icon[alt="GitHub"]')
    .forEach((img) => {
      img.src = isLight
