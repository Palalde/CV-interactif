...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateUI(favoritesObjects) {
    ...
    document.getElementById("favorites-empty").style.display = isEmpty
      ? "block"
      : "none";
    document.getElementById("favorites-grid").style.display = isEmpty
      ? "none"
      : "grid";
  ...
  function createFavoriteCard(competence) {
    ...
    removeBtn.setAttribute(
      "aria-label",
      `Retirer ${competence.name} des favoris`,
    );
